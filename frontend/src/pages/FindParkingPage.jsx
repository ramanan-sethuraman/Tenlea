      ...
      try {
        ...
        if (res && res.data) {
          const formatted = res.data.map((item) => ({
            ...
            amenities: item.amenities || ['24/7 Security', 'Gated Access', 'EV Charging'],
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col justify-between">
      ...
      <main className="grow pt-28 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-zinc-900/90 border border-zinc-800 mb-10 shadow-2xl">
        ...
        {/* Results Grid - Full Width Listings */}
