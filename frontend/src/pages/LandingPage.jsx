...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <section className="bg-zinc-900 border-t border-zinc-800/80 relative">
        <AnimatedBackground variant="slow" showGrid={false} showVehicles={false} className="py-24">
      ...
      <section className="bg-zinc-950 border-t border-zinc-800 relative">
        <AnimatedBackground variant="glow" showVideo={true} videoSrc="/cities-bg.mp4" grayscale={true} showGrid={false} showVehicles={false} className="py-20">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-4">
              {['Chennai', 'Bengaluru', 'Mumbai', 'Hyderabad', 'Delhi NCR'].map((cityName) => (
                <Link
                  ...
                  className="px-5 py-2.5 rounded-xl bg-zinc-900/90 border border-slate-300/30 text-white font-bold text-xs hover:bg-zinc-800 hover:border-slate-300 transition-all flex items-center gap-2"
                >
